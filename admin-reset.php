...
function resetAdminPassword($conn, $email)
{
    // Hash the new password
    $newPassword = password_hash("1234", PASSWORD_DEFAULT); // Default password for admin
...
if (isset($_POST['email'])) {
    ...
    // Reset the password
    if (resetAdminPassword($conn, $email)) {
        // Set success message
...
<body>
    <form method="POST" action="admin-reset.php">
        ...
        <?php if ($successMessage): ?>
            ...
            <a href="login.php" class="back-button">Go to Login</a>
        <?php else: ?>
