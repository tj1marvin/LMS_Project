...
$returned_books_sql = "SELECT b.id, b.title, s.first_name, s.last_name, ib.return_date 
                       FROM issue_book ib 
...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Returned Books</h3>
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="view-returned-book.php.php">Returned Books</a>
                </li>
            </ul>
        </div>
        <div class="row">
                        ...
                        <div class="card-body">
                            <?php if ($returned_books_result->num_rows > 0): ?>
                                <div class="table-responsive ">
                                    <table id="returnedBooksTable" class="table table-striped mt-3 table-hover">
                                        <thead>
                                            <tr>
                                                <th>Book Title</th>
                                                <th>Returned By</th>
                                        ...
                                        <tbody>
                                            <?php while ($returned_book = $returned_books_result->fetch_assoc()): ?>
                                                <tr>
                                                    <td><?php echo htmlspecialchars($returned_book['title']); ?></td>
                                                    <td><?php echo htmlspecialchars($returned_book['first_name'] . ' ' . $returned_book['last_name']); ?></td>
                                                    <td><?php echo htmlspecialchars($returned_book['return_date']); ?></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                    </table>
