...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $days = intval($_POST['days']); // Get the number of days from the form
...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Issue Book</h3>
            <ul class="breadcrumbs mb-3">
                <li class="nav-home">
                    <a href="index.php"> <!-- Fixed the link to index.php -->
                        <i class="icon-home"></i>
                    </a>
                </li>
                <li class="separator">
                    ...
                    <div class="card-body">
                        <form method="POST" action="issue-book.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="days" id="days" class="form-control" min="1" required placeholder="Enter number of days" />
                            </div>
