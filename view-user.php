...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql = "SELECT * FROM students_registration WHERE student_id = ?";
    ...
    // Invalid student ID or ID not provided
    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item active">
                    <a href="view-students.php" class="nav-link">View User Details</a>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="card user-card">
                    ...
                    <div class="card-body">
                        <?php if ($user): ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4 detail-label">Enrollment No:</div>
                                <div class="col-md-8"><?php echo htmlspecialchars($user['enrollment_no']); ?></div>
                            </div>
                             <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8"><?php echo htmlspecialchars($user['contact'] ? $user['contact'] : 'N/A'); ?></div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4 detail-label">Membership Status:</div>
                                <div class="col-md-8"><?php echo htmlspecialchars(ucfirst($user['approved'])); ?></div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4 detail-label">Joined Date:</div>
                                <div class="col-md-8"><?php echo htmlspecialchars(date('d M Y h:i A', strtotime($user['created_at']))); ?></div>
                            </div>
                             <div class="row">
                                <div class="col-md-4 detail-label">Profile Image:</div>
                                <div class="col-md-8">
                                     <?php if ($user['student_img']): ?>
                                        <img src="<?php echo htmlspecialchars($user['student_img']); ?>" alt="Student Image" class="student-img-preview" style="width: 400px; height: auto;">
                                    <?php else: ?>
                    ...
                    <div class="card-footer text-right">
                        <a href="view-students.php" class="btn btn-secondary">Back to User List</a>
                    </div>
                </div>
            </div>
        </div>
