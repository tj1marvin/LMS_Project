...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Return Book</h3>
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="view-returned-book.php">Return Book</a>
                </li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Return a Book</div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="issue_id" id="issue_id" class="form-control" required>
                                    ...
                                    <?php while ($issued_book = $issued_books_result->fetch_assoc()): ?>
                                        <option value="<?php echo $issued_book['issue_id']; ?>">
                                            <?php echo $issued_book['title'] . ' - Issued to: ' . $issued_book['first_name'] . ' ' . $issued_book['last_name'] . ' on ' . $issued_book['issue_date']; ?>
                                        </option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
